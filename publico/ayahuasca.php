...
<head>
    ...
    <style>
        /* ── Ayahuasca palette — deep forest / moss / warm parchment ── */
        :root {
            --med-bg:            #080e0a;
            --med-bg2:           #0d1611;
            --med-surface:       rgba(78, 110, 93, 0.07);
            --med-border:        rgba(78, 110, 93, 0.18);
            --med-border-bright: rgba(78, 110, 93, 0.48);
            --med-accent:        #5c8c72;
            --med-text:          #d0c5b0;
            --med-text-dim:      rgba(208, 197, 176, 0.52);
            --med-glow:          rgba(92, 140, 114, 0.22);
            --med-glow-strong:   rgba(92, 140, 114, 0.52);
        }
    </style>
</head>
<body>
    ...
    <header class="med-hero">
        ...
        <h1>AYAHUASCA</h1>
        <div class="med-hero-rule"></div>
        <p class="med-hero-sub">«La enredadera que abre los ojos del espíritu»</p>
    </header>
    ...
    <nav class="med-bottom-nav" aria-label="Navegación entre medicinas">
        ...
        <div class="med-bottom-nav-links">
            ...
            <a href="rape.php" class="med-nav-link">
                Rapé
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden="true">
